...
* To understand more about the tools' API structure and details, please download the documentation via the Wiki link below and refer to Chapter 2:
...
*
*  COMPILATION
* Windows: Open Microsoft Visual Studio, then click the "Build Solution" button.
* Linux/macOS: Open the terminal and execute "make clean;make" command
*
*******************************************************************************************************************************************************************/
#define _GNU_SOURCE
